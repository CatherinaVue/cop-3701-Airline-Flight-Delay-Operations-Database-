...
Application Domain: 
My project simulates the database tracking operations of airlines as data from 2015 will be used to help identify the main causes for an airline's delay during this time.
...
Users:
My database would Primarily target:
...
Relationships:
One-to-many: Multiple flights can belong to the same airline.

Many-to-many: An airport can have many airlines and an airline can operate at many airports.
